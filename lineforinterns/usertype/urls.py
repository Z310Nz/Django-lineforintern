...
urlpatterns = [
    ...
    path("studentview/<str:role>/<str:username>/", views.studentview, name="studentview"), #Show Student who want to work page
    path('viewstudent/<str:student_id>/', view_student, name='viewstudent'), #View student to select status page
