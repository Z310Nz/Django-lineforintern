...
urlpatterns = [
    ...
    path(
        "profile/<str:role>/<str:username>/", views.profile, name="profile"
    ),  # Profile page
    path(
        "addinfo/<str:role>/<str:username>/", views.addinfo, name="addinfo"
    ),  # Add info page
    path(
        "editinfo/<str:role>/<str:username>/", views.editinfo, name="editinfo"
    ),  # Edit info page
    ...
    path(
        "companyselect/<str:role>/<str:username>/",
        views.viewselectcompany,
        name="companyselect",
    ),  # Company select page
    path(
