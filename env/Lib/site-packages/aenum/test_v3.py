...
class TestEnumV3(TestCase):
    ...
    def test_multivalue_and_auto(self):
        with self.assertRaisesRegex(
            TypeError, r"MultiValue and MagicValue are mutually exclusive"
        ):
    ...
    def test_autonumber_with_irregular_values(self):
        ...
        with self.assertRaisesRegex(
            TypeError,
            ".*number of fields provided do not match init ...x., .y.. != .3, 11, 13..",
        ):
    ...
    if pyver >= PY3_3:
        ...
        def test_missing(self):
            ...
            self.assertRaisesRegex(
                TypeError, "error in .*_missing_", Color, "bad return"
            )
...
class TestIssuesV3(TestCase):
    ...
    def test_extend_enum_with_init(self):
        ...
        self.assertEqual(
            list(Color), [Color.red, Color.green, Color.blue, Color.opacity]
        )
...
class TestExtendEnumV3(TestCase):
    ...
    def test_extend_enum_plain(self):
        ...
        self.assertRaisesRegex(
            TypeError,
            ".blue. already in use as .Color.blue: 3.",
            extend_enum,
            Color,
            "blue",
            5,
    ...
    def test_extend_enum_unique(self):
        ...
        self.assertRaisesRegex(
            ValueError,
            "<Color.verde: 2> is a duplicate of <Color.green: 2>",
            extend_enum,
            Color,
            "verde",
            2,
...
if __name__ == "__main__":
    raise RuntimeError(
        "'test_v3.py' should not be run by itself; it's included in 'test.py'"
    )
