...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import DeliveryContext' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
