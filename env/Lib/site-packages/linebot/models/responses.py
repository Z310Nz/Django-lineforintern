...
class RichMenuResponse(Base):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if areas:
            for area in areas:
                new_areas.append(self.get_or_new_from_json_dict(area, RichMenuArea))
    ...
    def __init__(self, aliases=None, **kwargs):
        ...
        if aliases:
            for alias in aliases:
                new_aliases.append(self.get_or_new_from_json_dict(alias, RichMenuAlias))
...
class InsightFollowersResponse(Base):
    ...
    def __init__(
        self, status=None, followers=None, targeted_reaches=None, blocks=None, **kwargs
    ):
        """__init__ method.
...
class InsightDemographicResponse(Base):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.genders = [
            self.get_or_new_from_json_dict(it, GenderInsight) for it in genders
        ]
        ...
        self.app_types = [
            self.get_or_new_from_json_dict(it, AppTypeInsight) for it in app_types
        ]
        self.subscription_periods = [
            self.get_or_new_from_json_dict(it, SubscriptionPeriodInsight)
...
class InsightMessageEventResponse(Base):
    ...
    def __init__(self, overview=None, messages=None, clicks=None, **kwargs):
        ...
        self.messages = [
            self.get_or_new_from_json_dict(it, MessageInsight) for it in messages
        ]
        self.clicks = [
            self.get_or_new_from_json_dict(it, ClickInsight) for it in clicks
        ]
...
class InsightMessageEventOfCustomAggregationUnitResponse(Base):
    ...
    def __init__(self, overview=None, messages=None, clicks=None, **kwargs):
        ...
        :param kwargs:
        """
        super(InsightMessageEventOfCustomAggregationUnitResponse, self).__init__(
            **kwargs
        )
...
class AudienceGroup(Base):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if jobs:
            self.jobs = [
                self.get_or_new_from_json_dict(job, JobInsight) for job in jobs
            ]
...
class IssueChannelTokenResponseV2(Base):
    ...
    def __init__(
        self, access_token=None, expires_in=None, token_type=None, key_id=None, **kwargs
    ):
        """__init__ method.
