...
class TextSendMessage(SendMessage):
    ...
    def __init__(self, text=None, emojis=None, quick_reply=None, sender=None, **kwargs):
        ...
        super(TextSendMessage, self).__init__(
            quick_reply=quick_reply, sender=sender, **kwargs
        )
...
class StickerSendMessage(SendMessage):
    ...
    def __init__(
        self, package_id=None, sticker_id=None, quick_reply=None, sender=None, **kwargs
    ):
        """__init__ method.
...
class QuickReply(with_metaclass(ABCMeta, Base)):
    ...
    def __init__(self, items=None, **kwargs):
        ...
        if items:
            for item in items:
                new_items.append(self.get_or_new_from_json_dict(item, QuickReplyButton))
