...
class CarouselTemplate(Template):
    ...
    def __init__(
        self, columns=None, image_aspect_ratio=None, image_size=None, **kwargs
    ):
        """__init__ method.
        ...
        if columns:
            for column in columns:
                new_columns.append(
                    self.get_or_new_from_json_dict(column, CarouselColumn)
                )
...
class ImageCarouselTemplate(Template):
    ...
    def __init__(self, columns=None, **kwargs):
        ...
        if columns:
            for column in columns:
                new_columns.append(
                    self.get_or_new_from_json_dict(column, ImageCarouselColumn)
                )
        self.columns = new_columns
