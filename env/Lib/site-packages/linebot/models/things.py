...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import ThingsContent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import LinkThingsContent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import UnlinkThingsContent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import ScenarioResultThingsContent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
class ScenarioResult(Things):
    ...
    def __init__(self, device_id=None, result=None, **kwargs):
        ...
        self.result = self.get_or_new_from_json_dict(result, ScenarioResultPayload)


@deprecated(
    reason="Use 'from linebot.v3.webhooks import ScenarioResult' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
class ScenarioResultPayload(Base):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.action_results = [
            self.get_or_new_from_json_dict(it, ActionResult) for it in action_results
        ]
...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import ActionResult' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
