...
class FlexSendMessage(SendMessage):
    ...
    def __init__(self, alt_text=None, contents=None, **kwargs):
        ...
        self.contents = self.get_or_new_from_json_dict_with_types(
            contents, {"bubble": BubbleContainer, "carousel": CarouselContainer}
        )
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.hero = self.get_or_new_from_json_dict_with_types(
            hero,
            {"image": ImageComponent, "box": BoxComponent, "video": VideoComponent},
        )
...
class BlockStyle(with_metaclass(ABCMeta, Base)):
    ...
    def __init__(
        self, background_color=None, separator=None, separator_color=None, **kwargs
    ):
        """__init__ method.
...
class CarouselContainer(FlexContainer):
    ...
    def __init__(self, contents=None, **kwargs):
        ...
        if contents:
            for it in contents:
                new_contents.append(self.get_or_new_from_json_dict(it, BubbleContainer))
...
class TextComponent(FlexComponent):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if contents:
            self.contents = [
                self.get_or_new_from_json_dict(it, SpanComponent) for it in contents
            ]
        else:
            self.contents = None
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.alt_content = self.get_or_new_from_json_dict_with_types(
            alt_content, {"image": ImageComponent, "box": BoxComponent}
        )
        self.aspect_ratio = aspect_ratio
        self.action = get_action(action)
