...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import VideoPlayComplete' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import MessageEvent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import FollowEvent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
class FollowEvent(Event):
    ...
    def __init__(
        self, mode=None, timestamp=None, source=None, reply_token=None, **kwargs
    ):
        """__init__ method.
...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import UnfollowEvent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import JoinEvent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import LeaveEvent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import PostbackEvent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
class PostbackEvent(Event):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.type = "postback"
        self.reply_token = reply_token
        self.postback = self.get_or_new_from_json_dict(postback, Postback)


@deprecated(
    reason="Use 'from linebot.v3.webhooks import BeaconEvent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
class BeaconEvent(Event):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.type = "beacon"
        self.reply_token = reply_token
        self.beacon = self.get_or_new_from_json_dict(beacon, Beacon)


@deprecated(
    reason="Use 'from linebot.v3.webhooks import MemberJoinedEvent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
class MemberJoinedEvent(Event):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.reply_token = reply_token
        self.joined = self.get_or_new_from_json_dict(joined, Joined)


@deprecated(
    reason="Use 'from linebot.v3.webhooks import MemberLeftEvent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
class MemberLeftEvent(Event):
    ...
    def __init__(self, mode=None, timestamp=None, source=None, left=None, **kwargs):
        ...
        self.left = self.get_or_new_from_json_dict(left, Left)


@deprecated(
    reason="Use 'from linebot.v3.webhooks import AccountLinkEvent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
class AccountLinkEvent(Event):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.reply_token = reply_token
        self.link = self.get_or_new_from_json_dict(link, Link)


@deprecated(
    reason="Use 'from linebot.v3.webhooks import ThingsEvent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import UnsendEvent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
class UnsendEvent(Event):
    ...
    def __init__(self, mode=None, timestamp=None, source=None, unsend=None, **kwargs):
        ...
        self.type = "unsend"
        self.unsend = self.get_or_new_from_json_dict(unsend, Unsend)


@deprecated(
    reason="Use 'from linebot.v3.webhooks import VideoPlayCompleteEvent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
...
@deprecated(
    reason="Use 'from linebot.v3.models import UnknownEvent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import PostbackContent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
class Postback(Base):
...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import BeaconContent' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
class Beacon(Base):
...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import JoinedMembers' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
class Joined(Base):
...
@deprecated(
    reason="Use 'from linebot.v3.webhooks import LeftMembers' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
class Left(Base):
