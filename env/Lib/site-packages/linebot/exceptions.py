...
@deprecated(
    reason="Use 'from linebot.v3.exceptions import InvalidSignatureError' and v3 webhook handlers instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
...
class LineBotApiError(BaseError):
    ...
    def __str__(self):
        ...
        if self.accepted_request_id:
            return (
                "{0}: status_code={1}, request_id={2}, "
                "accepted_request_id={3}, error_response={4}, headers={5}".format(
