...
class IssueStatelessChannelAccessTokenResponse(BaseModel):
    ...
    access_token: StrictStr = Field(
        ...,
        description="A stateless channel access token. The token is an opaque string which means its format is an implementation detail and the consumer of this token should never try to use the data parsed from the token. ",
    )
