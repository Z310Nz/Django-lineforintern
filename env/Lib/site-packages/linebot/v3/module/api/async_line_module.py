...
from linebot.v3.module.models.acquire_chat_control_request import (
...
from linebot.v3.module.exceptions import ApiTypeError, ApiValueError  # noqa: F401
...
class AsyncLineModule(object):
    ...
    @overload
    async def acquire_chat_control(
        self,
        chat_id: Annotated[
            StrictStr, Field(..., description="The `userId`, `roomId`, or `groupId`")
        ],
        acquire_chat_control_request: Optional[AcquireChatControlRequest] = None,
        **kwargs
    ) -> None:  # noqa: E501
        ...
    ...
    def acquire_chat_control(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the acquire_chat_control_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.acquire_chat_control_with_http_info(
            chat_id, acquire_chat_control_request, **kwargs
        )  # noqa: E501
    ...
    def acquire_chat_control_with_http_info(
        ...
        **kwargs
        ...
        _all_params = ["chat_id", "acquire_chat_control_request"]
        _all_params.extend(
            [
                "async_req",
    ...
    async def detach_module(
        self, detach_module_request: Optional[DetachModuleRequest] = None, **kwargs
    ) -> None:  # noqa: E501
        ...
    ...
    def detach_module(
        self,
        detach_module_request: Optional[DetachModuleRequest] = None,
        async_req: Optional[bool] = True,
        **kwargs
    ) -> None:  # noqa: E501
        ...
    ...
    def detach_module(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the detach_module_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.detach_module_with_http_info(
            detach_module_request, **kwargs
        )  # noqa: E501
    ...
    def detach_module_with_http_info(
        ...
        _all_params = ["detach_module_request"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
    ...
    async def get_modules(
        ...
        start: Annotated[
            Optional[StrictStr],
            Field(
                description="Value of the continuation token found in the next property of the JSON object returned in the response. If you can't get all basic information about the bots in one request, include this parameter to get the remaining array. "
            ),
        ] = None,
        limit: Annotated[
            Optional[conint(strict=True, le=100)],
            Field(
                description="Specify the maximum number of bots that you get basic information from. The default value is 100. Max value: 100 "
            ),
        ] = None,
        **kwargs
    ...
    def get_modules(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_modules_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
    ...
    @overload
    async def release_chat_control(
        self,
        chat_id: Annotated[
            StrictStr, Field(..., description="The `userId`, `roomId`, or `groupId`")
        ],
    ...
    def release_chat_control(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the release_chat_control_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
