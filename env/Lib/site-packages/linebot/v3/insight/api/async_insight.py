...
from linebot.v3.insight.models.get_number_of_followers_response import (
    GetNumberOfFollowersResponse,
)
from linebot.v3.insight.models.get_number_of_message_deliveries_response import (
    GetNumberOfMessageDeliveriesResponse,
)
from linebot.v3.insight.models.get_statistics_per_unit_response import (
...
from linebot.v3.insight.exceptions import ApiTypeError, ApiValueError  # noqa: F401
...
class AsyncInsight(object):
    ...
    @overload
    async def get_friends_demographics(
        self, **kwargs
    ) -> GetFriendsDemographicsResponse:  # noqa: E501
        ...
    ...
    def get_friends_demographics(
        ...
        GetFriendsDemographicsResponse, Awaitable[GetFriendsDemographicsResponse]
    ]:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_friends_demographics_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
    ...
    @overload
    async def get_message_event(
        self,
        request_id: Annotated[
            constr(strict=True, min_length=1),
            Field(
                ...,
                description="Request ID of a narrowcast message or broadcast message. Each Messaging API request has a request ID. ",
            ),
        ],
        **kwargs
    ...
    def get_message_event(
        ...
        **kwargs
        ...
        GetMessageEventResponse, Awaitable[GetMessageEventResponse]
    ]:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_message_event_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
    ...
    @overload
    async def get_number_of_followers(
        self,
        var_date: Annotated[
            Optional[constr(strict=True, max_length=8, min_length=8)],
            Field(
                description="Date for which to retrieve the number of followers.  Format: yyyyMMdd (e.g. 20191231) Timezone: UTC+9 "
            ),
        ] = None,
        **kwargs
    ) -> GetNumberOfFollowersResponse:  # noqa: E501
        ...
    ...
    def get_number_of_followers(
        ...
        **kwargs
        ...
        GetNumberOfFollowersResponse, Awaitable[GetNumberOfFollowersResponse]
    ]:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_number_of_followers_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.get_number_of_followers_with_http_info(
            var_date, **kwargs
        )  # noqa: E501
    ...
    @overload
    async def get_number_of_message_deliveries(
        self,
        var_date: Annotated[
            constr(strict=True, max_length=8, min_length=8),
            Field(
                ...,
                description="Date for which to retrieve number of sent messages. - Format: yyyyMMdd (e.g. 20191231) - Timezone: UTC+9 ",
            ),
        ],
        **kwargs
    ) -> GetNumberOfMessageDeliveriesResponse:  # noqa: E501
        ...
    ...
    def get_number_of_message_deliveries(
        ...
        **kwargs
        ...
        GetNumberOfMessageDeliveriesResponse,
        Awaitable[GetNumberOfMessageDeliveriesResponse],
    ]:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_number_of_message_deliveries_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.get_number_of_message_deliveries_with_http_info(
            var_date, **kwargs
        )  # noqa: E501
    ...
    async def get_statistics_per_unit(
        self,
        custom_aggregation_unit: Annotated[
            constr(strict=True, max_length=30, min_length=1),
            Field(
                ...,
                description="Name of aggregation unit specified when sending the message. Case-sensitive. For example, `Promotion_a` and `Promotion_A` are regarded as different unit names. ",
            ),
        ],
        var_from: Annotated[
            constr(strict=True, max_length=8, min_length=8),
            Field(
                ...,
                description="Start date of aggregation period.  Format: yyyyMMdd (e.g. 20210301) Time zone: UTC+9 ",
            ),
        ],
        to: Annotated[
            constr(strict=True, max_length=8, min_length=8),
            Field(
                ...,
                description="End date of aggregation period. The end date can be specified for up to 30 days later. For example, if the start date is 20210301, the latest end date is 20210331.  Format: yyyyMMdd (e.g. 20210301) Time zone: UTC+9 ",
            ),
        ],
        **kwargs
    ) -> GetStatisticsPerUnitResponse:  # noqa: E501
        ...
    ...
    def get_statistics_per_unit(
        ...
        **kwargs
        ...
        GetStatisticsPerUnitResponse, Awaitable[GetStatisticsPerUnitResponse]
    ]:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_statistics_per_unit_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.get_statistics_per_unit_with_http_info(
            custom_aggregation_unit, var_from, to, **kwargs
        )  # noqa: E501
    ...
    def get_statistics_per_unit_with_http_info(
        ...
        **kwargs
        ...
        _all_params = ["custom_aggregation_unit", "var_from", "to"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        if _params.get("custom_aggregation_unit") is not None:  # noqa: E501
            _query_params.append(
                ("customAggregationUnit", _params["custom_aggregation_unit"])
            )
