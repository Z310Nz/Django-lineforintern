...
class GetStatisticsPerUnitResponseMessage(BaseModel):
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if (
            self.media_played25_percent is None
            and "media_played25_percent" in self.__fields_set__
        ):
        ...
        # and __fields_set__ contains the field
        if (
            self.media_played50_percent is None
            and "media_played50_percent" in self.__fields_set__
        ):
        ...
        # and __fields_set__ contains the field
        if (
            self.media_played75_percent is None
            and "media_played75_percent" in self.__fields_set__
        ):
        ...
        # and __fields_set__ contains the field
        if (
            self.media_played100_percent is None
            and "media_played100_percent" in self.__fields_set__
        ):
        ...
        # and __fields_set__ contains the field
        if (
            self.unique_impression is None
            and "unique_impression" in self.__fields_set__
        ):
        ...
        # and __fields_set__ contains the field
        if (
            self.unique_media_played is None
            and "unique_media_played" in self.__fields_set__
        ):
        ...
        # and __fields_set__ contains the field
        if (
            self.unique_media_played25_percent is None
            and "unique_media_played25_percent" in self.__fields_set__
        ):
        ...
        # and __fields_set__ contains the field
        if (
            self.unique_media_played50_percent is None
            and "unique_media_played50_percent" in self.__fields_set__
        ):
        ...
        # and __fields_set__ contains the field
        if (
            self.unique_media_played75_percent is None
            and "unique_media_played75_percent" in self.__fields_set__
        ):
        ...
        # and __fields_set__ contains the field
        if (
            self.unique_media_played100_percent is None
            and "unique_media_played100_percent" in self.__fields_set__
        ):
        ...
        _obj = GetStatisticsPerUnitResponseMessage.parse_obj(
            {
                ...
                "unique_media_played100_percent": obj.get(
                    "uniqueMediaPlayed100Percent"
                ),
            }
        )
