...
from linebot.v3.insight.models.get_message_event_response_click import (
    GetMessageEventResponseClick,
)
from linebot.v3.insight.models.get_message_event_response_message import (
    GetMessageEventResponseMessage,
)
from linebot.v3.insight.models.get_message_event_response_overview import (
...
class GetMessageEventResponse(BaseModel):
    ...
    messages: Optional[conlist(GetMessageEventResponseMessage)] = Field(
        None, description="Array of information about individual message bubbles."
    )
    clicks: Optional[conlist(GetMessageEventResponseClick)] = Field(
        None, description="Array of information about opened URLs in the message."
    )
    ...
    def from_dict(cls, obj: dict) -> GetMessageEventResponse:
        ...
        _obj = GetMessageEventResponse.parse_obj(
            {
                "overview": (
                    GetMessageEventResponseOverview.from_dict(obj.get("overview"))
                    if obj.get("overview") is not None
                    else None
                ),
                "messages": (
                    [
                        GetMessageEventResponseMessage.from_dict(_item)
                ...
                "clicks": (
                    [
                        GetMessageEventResponseClick.from_dict(_item)
                        for _item in obj.get("clicks")
                    ]
                    if obj.get("clicks") is not None
                    else None
                ),
            }
        )
