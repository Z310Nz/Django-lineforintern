...
class GetNumberOfMessageDeliveriesResponse(BaseModel):
    ...
    status: Optional[StrictStr] = Field(
        None, description="Status of the counting process."
    )
    broadcast: Optional[StrictInt] = Field(
        None,
        description="Number of messages sent to all of this LINE Official Account's friends (broadcast messages).",
    )
    targeting: Optional[StrictInt] = Field(
        None,
    ...
    auto_response: Optional[StrictInt] = Field(
        None, alias="autoResponse", description="Number of auto-response messages sent."
    )
    welcome_response: Optional[StrictInt] = Field(
        None, alias="welcomeResponse", description="Number of greeting messages sent."
    )
    chat: Optional[StrictInt] = Field(
        None,
