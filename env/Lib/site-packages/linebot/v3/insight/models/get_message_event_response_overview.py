...
class GetMessageEventResponseOverview(BaseModel):
    ...
    request_id: Optional[StrictStr] = Field(
        None, alias="requestId", description="Request ID."
    )
    timestamp: Optional[StrictInt] = Field(
        None, description="UNIX timestamp for message delivery time in seconds."
    )
    delivered: Optional[StrictInt] = Field(
        None,
        description="Number of messages delivered. This property shows values of less than 20. However, if all messages have not been sent, it will be null. ",
    )
    ...
    unique_click: Optional[StrictInt] = Field(
        None,
        alias="uniqueClick",
