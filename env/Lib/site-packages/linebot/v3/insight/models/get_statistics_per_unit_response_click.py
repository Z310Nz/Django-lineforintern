...
class GetStatisticsPerUnitResponseClick(BaseModel):
    ...
    click: Optional[StrictInt] = Field(
        None, description="Number of times the URL in the bubble was opened."
    )
    ...
    unique_click_of_request: Optional[StrictInt] = Field(
        None,
        alias="uniqueClickOfRequest",
        description="Number of users who opened this url through any link in the message. If another message bubble contains the same URL and a user opens both links, it's counted only once. ",
    )
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if (
            self.unique_click_of_request is None
            and "unique_click_of_request" in self.__fields_set__
        ):
