...
class SubscriptionPeriodTile(BaseModel):
    ...
    subscription_period: Optional[StrictStr] = Field(
        None,
        alias="subscriptionPeriod",
    ...
    percentage: Optional[Union[StrictFloat, StrictInt]] = Field(
        None, description="Percentage. Possible values: [0.0,100.0] e.g. 0, 2.9, 37.6."
    )
    ...
    def subscription_period_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('within7days', 'within30days', 'within90days', 'within180days', 'within365days', 'over365days', 'unknown')"
            )
        return value
