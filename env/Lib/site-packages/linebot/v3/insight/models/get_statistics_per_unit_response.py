...
class GetStatisticsPerUnitResponse(BaseModel):
    ...
    messages: conlist(GetStatisticsPerUnitResponseMessage) = Field(
        ..., description="Array of information about individual message bubbles."
    )
    clicks: conlist(GetStatisticsPerUnitResponseClick) = Field(
    ...
    def from_dict(cls, obj: dict) -> GetStatisticsPerUnitResponse:
        ...
        _obj = GetStatisticsPerUnitResponse.parse_obj(
            {
                "overview": (
                    GetStatisticsPerUnitResponseOverview.from_dict(obj.get("overview"))
                    if obj.get("overview") is not None
                    else None
                ),
                "messages": (
                    [
                        GetStatisticsPerUnitResponseMessage.from_dict(_item)
                ...
                "clicks": (
                    [
                        GetStatisticsPerUnitResponseClick.from_dict(_item)
