...
class LiffApp(BaseModel):
    ...
    liff_id: Optional[StrictStr] = Field(
        None, alias="liffId", description="LIFF app ID"
    )
    ...
    permanent_link_pattern: Optional[StrictStr] = Field(
        ...
        description="How additional information in LIFF URLs is handled. concat is returned. ",
    )
