...
class AddLiffAppRequest(BaseModel):
    ...
    description: Optional[StrictStr] = Field(
        None,
        description='Name of the LIFF app.  The LIFF app name can\'t include "LINE" or similar strings, or inappropriate strings. ',
    )
    features: Optional[LiffFeatures] = None
    permanent_link_pattern: Optional[StrictStr] = Field(
        None,
        alias="permanentLinkPattern",
        description="How additional information in LIFF URLs is handled. Specify `concat`. ",
    )
    ...
    def from_dict(cls, obj: dict) -> AddLiffAppRequest:
        ...
        _obj = AddLiffAppRequest.parse_obj(
            {
                "view": (
                    LiffView.from_dict(obj.get("view"))
                    if obj.get("view") is not None
                    else None
                ),
                "description": obj.get("description"),
                "features": (
                    LiffFeatures.from_dict(obj.get("features"))
