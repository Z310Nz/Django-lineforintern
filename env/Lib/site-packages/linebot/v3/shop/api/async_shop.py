...
from linebot.v3.shop.exceptions import ApiTypeError, ApiValueError  # noqa: F401
...
class AsyncShop(object):
    ...
    @overload
    async def mission_sticker_v3(
        self, mission_sticker_request: MissionStickerRequest, **kwargs
    ) -> None:  # noqa: E501
        ...
    ...
    def mission_sticker_v3(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the mission_sticker_v3_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.mission_sticker_v3_with_http_info(
            mission_sticker_request, **kwargs
        )  # noqa: E501
    ...
    def mission_sticker_v3_with_http_info(
        ...
        _all_params = ["mission_sticker_request"]
        _all_params.extend(
            [
                "async_req",
