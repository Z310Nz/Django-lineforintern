...
class TextMessageContent(MessageContent):
    ...
    emojis: Optional[conlist(Emoji)] = Field(
        None,
        ...
        _obj = TextMessageContent.parse_obj(
            {
                ...
                "text": obj.get("text"),
                "emojis": (
                    [Emoji.from_dict(_item) for _item in obj.get("emojis")]
                    if obj.get("emojis") is not None
                    else None
                ),
                "mention": (
                    Mention.from_dict(obj.get("mention"))
                    if obj.get("mention") is not None
                    else None
                ),
