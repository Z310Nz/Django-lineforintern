        ...
        _obj = ImageMessageContent.parse_obj(
            {
                ...
                "id": obj.get("id"),
                "content_provider": (
                    ContentProvider.from_dict(obj.get("contentProvider"))
                    if obj.get("contentProvider") is not None
                    else None
                ),
                "image_set": (
                    ImageSet.from_dict(obj.get("imageSet"))
                    if obj.get("imageSet") is not None
                    else None
                ),
