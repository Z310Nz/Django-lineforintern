        ...
        _obj = VideoPlayCompleteEvent.parse_obj(
            {
                ...
                "delivery_context": (
                    DeliveryContext.from_dict(obj.get("deliveryContext"))
                    if obj.get("deliveryContext") is not None
                    else None
                ),
                "reply_token": obj.get("replyToken"),
                "video_play_complete": (
                    VideoPlayComplete.from_dict(obj.get("videoPlayComplete"))
                    if obj.get("videoPlayComplete") is not None
                    else None
                ),
            }
        )
