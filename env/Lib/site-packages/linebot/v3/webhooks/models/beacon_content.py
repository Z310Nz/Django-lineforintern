...
class BeaconContent(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> BeaconContent:
        ...
        _obj = BeaconContent.parse_obj(
            {"hwid": obj.get("hwid"), "type": obj.get("type"), "dm": obj.get("dm")}
        )
        return _obj
