...
from linebot.v3.webhooks.exceptions import ApiTypeError, ApiValueError  # noqa: F401
...
class Dummy(object):
    ...
    @validate_arguments
    def callback(
        self, callback_request: CallbackRequest, **kwargs
    ) -> str:  # noqa: E501
        """callback  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the callback_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
