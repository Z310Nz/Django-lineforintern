...
class CreateClickBasedAudienceGroupRequest(BaseModel):
    ...
    request_id: Optional[StrictStr] = Field(
        None,
        alias="requestId",
        description="The request ID of a broadcast or narrowcast message sent in the past 60 days. Each Messaging API request has a request ID. ",
    )
    click_url: Optional[constr(strict=True, max_length=2000)] = Field(
        None,
        alias="clickUrl",
        description="The URL clicked by the user. If empty, users who clicked any URL in the message are added to the list of recipients. Max character limit: 2,000 ",
    )
