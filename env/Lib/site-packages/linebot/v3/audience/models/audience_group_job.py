...
class AudienceGroupJob(BaseModel):
    ...
    audience_group_job_id: Optional[StrictInt] = Field(
        None, alias="audienceGroupJobId", description="A job ID."
    )
    audience_group_id: Optional[StrictInt] = Field(
        None, alias="audienceGroupId", description="An audience ID."
    )
    ...
    created: Optional[StrictInt] = Field(
        None, description="When the job was created (in UNIX time)."
    )
