...
class AudienceGroup(BaseModel):
    ...
    request_id: Optional[StrictStr] = Field(
        None,
        alias="requestId",
        description="The request ID that was specified when the audience was created. This is only included when `audienceGroup.type` is CLICK or IMP. ",
    )
    click_url: Optional[StrictStr] = Field(
        None,
        alias="clickUrl",
        description="The URL that was specified when the audience was created. This is only included when `audienceGroup.type` is CLICK and link URL is specified. ",
    )
