...
class GetAudienceGroupsResponse(BaseModel):
    ...
    audience_groups: Optional[conlist(AudienceGroup)] = Field(
        None,
    ...
    has_next_page: Optional[StrictBool] = Field(
        None, alias="hasNextPage", description="true when this is not the last page."
    )
    ...
    read_write_audience_group_total_count: Optional[StrictInt] = Field(
        None,
        alias="readWriteAudienceGroupTotalCount",
    ...
    size: Optional[StrictInt] = Field(
        None, description="The maximum number of audiences on the current page."
    )
        ...
        _obj = GetAudienceGroupsResponse.parse_obj(
            {
                "audience_groups": (
                    [
                        AudienceGroup.from_dict(_item)
                        for _item in obj.get("audienceGroups")
                    ]
                    if obj.get("audienceGroups") is not None
                    else None
                ),
                "has_next_page": obj.get("hasNextPage"),
                "total_count": obj.get("totalCount"),
                "read_write_audience_group_total_count": obj.get(
                    "readWriteAudienceGroupTotalCount"
                ),
                "page": obj.get("page"),
                "size": obj.get("size"),
