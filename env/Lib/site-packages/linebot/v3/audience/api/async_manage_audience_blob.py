...
class AsyncManageAudienceBlob(object):
    ...
    @overload
    async def add_user_ids_to_audience(
        self,
        file: Annotated[
            Union[StrictBytes, StrictStr],
            Field(
                ...,
                description="A text file with one user ID or IFA entered per line. Specify text/plain as Content-Type. Max file number: 1 Max number: 1,500,000 ",
            ),
        ],
        audience_group_id: Annotated[
            Optional[StrictInt], Field(description="The audience ID.")
        ] = None,
        upload_description: Annotated[
            Optional[StrictStr],
            Field(description="The description to register with the job"),
        ] = None,
        **kwargs
    ) -> None:  # noqa: E501
        ...
    ...
    def add_user_ids_to_audience(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the add_user_ids_to_audience_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.add_user_ids_to_audience_with_http_info(
            file, audience_group_id, upload_description, **kwargs
        )  # noqa: E501
    ...
    def add_user_ids_to_audience_with_http_info(
        ...
        **kwargs
        ...
        _all_params = ["file", "audience_group_id", "upload_description"]
        _all_params.extend(
            [
                "async_req",
    ...
    @overload
    async def create_audience_for_uploading_user_ids(
        self,
        file: Annotated[
            Union[StrictBytes, StrictStr],
            Field(
        ...
        is_ifa_audience: Annotated[
            Optional[StrictBool],
            Field(
                description="To specify recipients by IFAs: set `true`. To specify recipients by user IDs: set `false` or omit isIfaAudience property. "
            ),
        ] = None,
        upload_description: Annotated[
            Optional[StrictStr],
    ...
    def create_audience_for_uploading_user_ids(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the create_audience_for_uploading_user_ids_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.create_audience_for_uploading_user_ids_with_http_info(
            file, description, is_ifa_audience, upload_description, **kwargs
        )  # noqa: E501
    ...
    def create_audience_for_uploading_user_ids_with_http_info(
        ...
        **kwargs
        ...
        _all_params = ["file", "description", "is_ifa_audience", "upload_description"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
