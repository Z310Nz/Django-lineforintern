...
from linebot.v3.moduleattach.exceptions import ApiTypeError, ApiValueError  # noqa: F401
...
class AsyncLineModuleAttach(object):
    ...
    async def attach_module(
        ...
        grant_type: Annotated[
            Optional[StrictStr], Field(description="authorization_code")
        ] = None,
        code: Annotated[
            Optional[StrictStr],
            Field(description="Authorization code received from the LINE Platform."),
        ] = None,
        ...
        client_id: Annotated[
            Optional[StrictStr],
            Field(
                description="Instead of using Authorization header, you can use this parameter to specify the channel ID of the module channel. You can find the channel ID of the module channel in the LINE Developers Console. "
            ),
        ] = None,
        client_secret: Annotated[
            Optional[StrictStr],
            Field(
                description="Instead of using Authorization header, you can use this parameter to specify the channel secret of the module channel. You can find the channel secret of the module channel in the LINE Developers Console. "
            ),
        ] = None,
        region: Annotated[
            Optional[StrictStr],
    ...
    def attach_module(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the attach_module_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.attach_module_with_http_info(
            grant_type,
            code,
            redirect_uri,
            code_verifier,
