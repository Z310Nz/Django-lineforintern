...
class MulticastRequest(BaseModel):
    ...
    to: conlist(StrictStr, max_items=500, min_items=1) = Field(
        ...,
    ...
    custom_aggregation_units: Optional[
        conlist(constr(strict=True, max_length=30, min_length=1), max_items=1)
    ] = Field(
        None,
