...
class FlexBox(FlexComponent):
    ...
    def layout_validate_enum(cls, value):
        ...
        if value not in ("horizontal", "vertical", "baseline"):
            raise ValueError(
                "must be one of enum values ('horizontal', 'vertical', 'baseline')"
            )
        return value
    ...
    def justify_content_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('center', 'flex-start', 'flex-end', 'space-between', 'space-around', 'space-evenly')"
            )
        return value
    ...
    def align_items_validate_enum(cls, value):
        ...
        if value not in ("center", "flex-start", "flex-end"):
            raise ValueError(
                "must be one of enum values ('center', 'flex-start', 'flex-end')"
            )
        return value
        ...
        _obj = FlexBox.parse_obj(
            {
                ...
                "flex": obj.get("flex"),
                "contents": (
                    [FlexComponent.from_dict(_item) for _item in obj.get("contents")]
                ...
                "background": (
                    FlexBoxBackground.from_dict(obj.get("background"))
                    if obj.get("background") is not None
                    else None
                ),
            }
        )
