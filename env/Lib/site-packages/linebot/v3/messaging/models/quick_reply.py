...
class QuickReply(BaseModel):
    ...
    items: Optional[conlist(QuickReplyItem, max_items=13)] = Field(
        None, description="Quick reply button objects."
    )
    ...
    def from_dict(cls, obj: dict) -> QuickReply:
        ...
        _obj = QuickReply.parse_obj(
            {
                "items": (
                    [QuickReplyItem.from_dict(_item) for _item in obj.get("items")]
