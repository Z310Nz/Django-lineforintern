...
class Sender(BaseModel):
    ...
    name: Optional[constr(strict=True, max_length=20)] = Field(
        None, description="Display name. Certain words such as `LINE` may not be used."
    )
    icon_url: Optional[constr(strict=True, max_length=2000)] = Field(
        None,
        alias="iconUrl",
    ...
    def from_dict(cls, obj: dict) -> Sender:
        ...
        _obj = Sender.parse_obj(
            {"name": obj.get("name"), "icon_url": obj.get("iconUrl")}
        )
        return _obj
