...
class IssueLinkTokenResponse(BaseModel):
    ...
    link_token: StrictStr = Field(
        ...,
        alias="linkToken",
        description="Link token. Link tokens are valid for 10 minutes and can only be used once.  ",
    )
    ...
    def from_dict(cls, obj: dict) -> IssueLinkTokenResponse:
        ...
        _obj = IssueLinkTokenResponse.parse_obj({"link_token": obj.get("linkToken")})
        return _obj
