        ...
        _obj = OperatorDemographicFilter.parse_obj(
            {
                "type": obj.get("type"),
                "var_and": (
                    [DemographicFilter.from_dict(_item) for _item in obj.get("and")]
                    if obj.get("and") is not None
                    else None
                ),
                "var_or": (
                    [DemographicFilter.from_dict(_item) for _item in obj.get("or")]
                    if obj.get("or") is not None
                    else None
                ),
                "var_not": (
                    DemographicFilter.from_dict(obj.get("not"))
