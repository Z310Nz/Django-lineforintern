...
class ButtonsTemplate(Template):
    ...
    image_background_color: Optional[StrictStr] = Field(
        None, alias="imageBackgroundColor"
    )
        ...
        _obj = ButtonsTemplate.parse_obj(
            {
                ...
                "text": obj.get("text"),
                "default_action": (
                    Action.from_dict(obj.get("defaultAction"))
                    if obj.get("defaultAction") is not None
                    else None
                ),
                "actions": (
                    [Action.from_dict(_item) for _item in obj.get("actions")]
