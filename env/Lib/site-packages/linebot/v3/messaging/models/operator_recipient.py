...
class OperatorRecipient(Recipient):
    ...
    var_and: Optional[conlist(Recipient)] = Field(
        None,
        alias="and",
    ...
    var_or: Optional[conlist(Recipient)] = Field(
        None,
        alias="or",
        ...
        _obj = OperatorRecipient.parse_obj(
            {
                "type": obj.get("type"),
                "var_and": (
                    [Recipient.from_dict(_item) for _item in obj.get("and")]
                    if obj.get("and") is not None
                    else None
                ),
                "var_or": (
                    [Recipient.from_dict(_item) for _item in obj.get("or")]
                    if obj.get("or") is not None
                    else None
                ),
                "var_not": (
                    Recipient.from_dict(obj.get("not"))
