...
class RichMenuBatchProgressResponse(BaseModel):
    ...
    accepted_time: datetime = Field(
        ...,
        alias="acceptedTime",
        description="The accepted time in milliseconds of the request of batch control the rich menu.  Format: ISO 8601 (e.g. 2023-06-08T10:15:30.121Z) Timezone: UTC ",
    )
    completed_time: Optional[datetime] = Field(
        None,
        alias="completedTime",
        description="The completed time in milliseconds of rich menu batch control. Returned when the phase property is succeeded or failed.  Format: ISO 8601 (e.g. 2023-06-08T10:15:30.121Z) Timezone: UTC ",
    )
