...
class FlexBubbleStyles(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> FlexBubbleStyles:
        ...
        _obj = FlexBubbleStyles.parse_obj(
            {
                "header": (
                    FlexBlockStyle.from_dict(obj.get("header"))
                    if obj.get("header") is not None
                    else None
                ),
                "hero": (
                    FlexBlockStyle.from_dict(obj.get("hero"))
                    if obj.get("hero") is not None
                    else None
                ),
                "body": (
                    FlexBlockStyle.from_dict(obj.get("body"))
                    if obj.get("body") is not None
                    else None
                ),
                "footer": (
                    FlexBlockStyle.from_dict(obj.get("footer"))
