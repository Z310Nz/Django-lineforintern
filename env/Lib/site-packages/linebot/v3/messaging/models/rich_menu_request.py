...
class RichMenuRequest(BaseModel):
    ...
    name: Optional[constr(strict=True, max_length=300)] = Field(
        None,
        description="Name of the rich menu. This value can be used to help manage your rich menus and is not displayed to users.",
    )
    chat_bar_text: Optional[constr(strict=True, max_length=14)] = Field(
        None, alias="chatBarText", description="Text displayed in the chat bar"
    )
    areas: Optional[conlist(RichMenuArea)] = Field(
        None,
