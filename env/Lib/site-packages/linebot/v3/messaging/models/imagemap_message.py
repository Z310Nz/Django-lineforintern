        ...
        _obj = ImagemapMessage.parse_obj(
            {
                "type": obj.get("type"),
                "quick_reply": (
                    QuickReply.from_dict(obj.get("quickReply"))
                    if obj.get("quickReply") is not None
                    else None
                ),
                "sender": (
                    Sender.from_dict(obj.get("sender"))
                ...
                "base_size": (
                    ImagemapBaseSize.from_dict(obj.get("baseSize"))
                    if obj.get("baseSize") is not None
                    else None
                ),
                "actions": (
                    [ImagemapAction.from_dict(_item) for _item in obj.get("actions")]
                    if obj.get("actions") is not None
                    else None
                ),
                "video": (
                    ImagemapVideo.from_dict(obj.get("video"))
