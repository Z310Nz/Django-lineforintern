...
class ErrorResponse(BaseModel):
    ...
    details: Optional[conlist(ErrorDetail)] = Field(
        None,
        description="An array of error details. If the array is empty, this property will not be included in the response.",
    )
    sent_messages: Optional[conlist(SentMessage, max_items=5, min_items=1)] = Field(
        None, alias="sentMessages", description="Array of sent messages."
    )
        ...
        _obj = ErrorResponse.parse_obj(
            {
                ...
                "details": (
                    [ErrorDetail.from_dict(_item) for _item in obj.get("details")]
