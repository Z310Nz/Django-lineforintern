...
class AsyncMessagingApiBlob(object):
    ...
    async def get_message_content(
        ...
        message_id: Annotated[
            StrictStr, Field(..., description="Message ID of video or audio")
        ],
        **kwargs
    ) -> bytearray:  # noqa: E501
        ...
    ...
    def get_message_content(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_message_content_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.get_message_content_with_http_info(
            message_id, **kwargs
        )  # noqa: E501
    ...
    @overload
    async def get_message_content_preview(
        self,
        message_id: Annotated[
            StrictStr, Field(..., description="Message ID of image or video")
        ],
        **kwargs
    ) -> bytearray:  # noqa: E501
        ...
    ...
    def get_message_content_preview(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_message_content_preview_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.get_message_content_preview_with_http_info(
            message_id, **kwargs
        )  # noqa: E501
    ...
    @overload
    async def get_message_content_transcoding_by_message_id(
        self,
        message_id: Annotated[
            StrictStr, Field(..., description="Message ID of video or audio")
        ],
        **kwargs
    ) -> GetMessageContentTranscodingResponse:  # noqa: E501
        ...
    ...
    def get_message_content_transcoding_by_message_id(
        ...
        **kwargs
        ...
        GetMessageContentTranscodingResponse,
        Awaitable[GetMessageContentTranscodingResponse],
    ]:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_message_content_transcoding_by_message_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.get_message_content_transcoding_by_message_id_with_http_info(
            message_id, **kwargs
        )  # noqa: E501
    ...
    @overload
    async def get_rich_menu_image(
        self,
        rich_menu_id: Annotated[
            StrictStr,
            Field(
    ...
    def get_rich_menu_image(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_rich_menu_image_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.get_rich_menu_image_with_http_info(
            rich_menu_id, **kwargs
        )  # noqa: E501
    ...
    async def set_rich_menu_image(
        ...
        rich_menu_id: Annotated[
            StrictStr,
            Field(..., description="The ID of the rich menu to attach the image to"),
        ],
    ...
    def set_rich_menu_image(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the set_rich_menu_image_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        if async_req is not None:
            kwargs["async_req"] = async_req
        return self.set_rich_menu_image_with_http_info(
            rich_menu_id, body, **kwargs
        )  # noqa: E501
