...
@deprecated(
    reason="Use 'from linebot.v3.webhook import SignatureValidator' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
...
class SignatureValidator(object):
    ...
    def validate(self, body, signature):
        ...
        gen_signature = hmac.new(
            self.channel_secret, body.encode("utf-8"), hashlib.sha256
        ).digest()
...
@deprecated(
    reason="Use 'from linebot.v3.webhook import WebhookPayload' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
...
@deprecated(
    reason="Use 'from linebot.v3.webhook import WebhookParser' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
    ...
    def parse(self, body, signature, as_payload=False, use_raw_message=False):
        ...
        for event in body_json["events"]:
            ...
            if event_type == "message":
                events.append(
                    MessageEvent.new_from_json_dict(
                        event, use_raw_message=use_raw_message
                    )
                )
        ...
        if as_payload:
            return WebhookPayload(
                events=events, destination=body_json.get("destination")
            )
        else:
            return events
...
@deprecated(
    reason="Use 'from linebot.v3.webhook import WebhookHandler' instead. See https://github.com/line/line-bot-sdk-python/blob/master/README.rst for more details.",
    version="3.0.0",
    category=LineBotSdkDeprecatedIn30,
)  # noqa: E501
class WebhookHandler(object):
    ...
    def handle(self, body, signature, use_raw_message=False):
        ...
        payload = self.parser.parse(
            body, signature, as_payload=True, use_raw_message=use_raw_message
        )
